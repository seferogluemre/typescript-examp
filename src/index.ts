...
const formFromClass = document.querySelector(
  ".signup-form"
...
class UserController {
  ...
  constructor({ firstName, lastName, age, phoneNumber, email }: UserParams) {
  ...
  removeFromCart(name: (typeof Product)["name"]) {
    const otherProduct = this.cart.filter((product) => product.name !== name);
    this.cart = otherProduct;
  }
}
